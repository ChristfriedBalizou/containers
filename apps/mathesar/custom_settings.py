...
INSTALLED_APPS = list(INSTALLED_APPS) + ['storages', 'oidc_provider']
...
AWS_QUERYSTRING_AUTH = os.environ.get('AWS_QUERYSTRING_AUTH', 'False').lower() in ('true', '1', 't')
...
OIDC_RP_ISSUER_OP = os.environ.get('OIDC_RP_ISSUER_OP') # The base URL of your OIDC provider
OIDC_RP_REDIRECT_URI = os.environ.get('OIDC_RP_REDIRECT_URI') # Adjust to your Mathesar's callback URL
OIDC_RP_SCOPES = os.environ.get('OIDC_RP_SCOPES', 'openid email profile') # Adjust scopes as needed
OIDC_RP_VERIFY_SSL = os.environ.get('OIDC_RP_VERIFY_SSL', 'true').lower() in ('true', '1', 't')
